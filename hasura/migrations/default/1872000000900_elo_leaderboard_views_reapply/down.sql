-- Restore the complete pre-four-view leaderboard function definitions.
DROP FUNCTION IF EXISTS public.get_player_leaderboard_rank(TEXT, INT, TEXT, TEXT, BOOLEAN, UUID, TEXT);
DROP FUNCTION IF EXISTS public.get_leaderboard(TEXT, INT, TEXT, BOOLEAN, TEXT, UUID, TEXT);
DROP FUNCTION IF EXISTS public._leaderboard_elo(INT, TEXT, BOOLEAN, UUID, TEXT);
