-- Restore the rolling-window-only _leaderboard_elo (no active-season
-- tournament inclusion, no true Last Match for named seasons),
-- matching what 1877000000500 last deployed.
